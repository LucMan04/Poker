...
public class Poker {
    ...
    public void play() {
        ...
        while (true){
            ...
            System.out.print("How much would you like to wager?(Value between 1 and 25) $");
            String input = in.nextLine();
            checkQuit(input);
            wager = checkValidInput(input);
            if(wager > player.getChips() || wager < 0 || wager > 25){
                ...
                if (multiplier == 0) {
                    ...
                    msg = "That's a Three-of-a-kind!";
                }else if(multiplier == 5){
                    msg = "That's a Straight!";
                }else if(multiplier == 10){
                    msg = "That's a Flush";
                }else if (multiplier == 15){
                    msg = "That's a Full House!";
                }else if(multiplier == 25){
                    msg = "That's a Four-of-a-kind!";
                }else if (multiplier == 50){
                    msg = "That's a Straight Flush!";
                }else if(multiplier == 100) {
                    msg = "That's a Royal Flush!";
                }
